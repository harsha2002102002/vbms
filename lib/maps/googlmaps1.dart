...
class GoogleMapScreen1 extends StatefulWidget {
  const GoogleMapScreen1({
    super.key,
  ...
  @override
  _GoogleMapScreen1State createState() => _GoogleMapScreen1State();
}

class _GoogleMapScreen1State extends State<GoogleMapScreen1> {
